...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Train a model for a given year and month"
    )
    parser.add_argument("--year", type=int, help="Year to train the model")
    parser.add_argument("--month", type=int, help="Month to train the model")
    args = parser.parse_args()

    # call the run function with the provided year and month
